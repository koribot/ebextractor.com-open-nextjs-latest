/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: cf41231cbc6d9e983245dc39e3065731)
// Runtime types generated with workerd@1.20260430.1 2026-05-01 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		EBEXTRACTOR_KV: KVNamespace;
		EBEXTRACTOR_ANALYTICS_DB: D1Database;
		EBEXTRACTOR_MY_SAVED_DB: D1Database;
		IMAGES: ImagesBinding;
		ASSETS: Fetcher;
		NEXTJS_ENV: string;
		CLOUDFLARE_TURNSTILE_SECRETKEY: string;
		NEXT_PUBLIC_SUPABASE_ANON_KEY: string;
		NEXT_PUBLIC_SUPABASE_URL: string;
		BASE_URL: string;
		CID: string;
		CS: string;
		AMZ_ACCESS_KEY: string;
		AMZ_SECRET_KEY: string;
		AMZ_PARTNER_TAG: string;
		NEXT_PUBLIC_WHAT_AMAZON_API: string;
		NEXT_PUBLIC_GOOGLE_ADSENSE_CLIENT: string;
		ALI_APP_KEY: string;
		ALI_APP_SECRET: string;
		CLOUDFLARE_BROWSER_RENDERING_API_TOKEN: string;
		CLOUDFLARE_ACCOUNT_ID: string;
		WORKER_SELF_REFERENCE: Fetcher /* ebextractor-open-next-js-latest */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXTJS_ENV" | "CLOUDFLARE_TURNSTILE_SECRETKEY" | "NEXT_PUBLIC_SUPABASE_ANON_KEY" | "NEXT_PUBLIC_SUPABASE_URL" | "BASE_URL" | "CID" | "CS" | "AMZ_ACCESS_KEY" | "AMZ_SECRET_KEY" | "AMZ_PARTNER_TAG" | "NEXT_PUBLIC_WHAT_AMAZON_API" | "NEXT_PUBLIC_GOOGLE_ADSENSE_CLIENT" | "ALI_APP_KEY" | "ALI_APP_SECRET" | "CLOUDFLARE_BROWSER_RENDERING_API_TOKEN" | "CLOUDFLARE_ACCOUNT_ID">> {}
}
